...
private var controller : ControladorConCamara;
...
function Awake ()
{
	...
	if (_target)
	{
		controller = _target.GetComponent(ControladorConCamara);
	}
	...
	if (controller)
	{
		...
		Debug.Log("Please assign a target to the camera that has a ControladorConCamara script attached.");
